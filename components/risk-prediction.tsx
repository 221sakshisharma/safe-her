    ...
    <Card className="border-border bg-card">
      ...
      <CardContent className="pb-4">
            ...
            return (
              <div key={h.hour} className="group flex flex-1 flex-col items-center gap-1">
                <div className="relative w-full" style={{ height: 100 }}>
                  <div
                    className={`absolute bottom-0 w-full rounded-t transition-all ${getBarColor(h.risk)} group-hover:opacity-80`}
        ...
        <div className="mt-3 flex items-center justify-between border-t border-border pt-3">
          <p className="text-[10px] text-muted-foreground">Peak risk: 10PM - 12AM</p>
