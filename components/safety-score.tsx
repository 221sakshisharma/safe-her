...
function getScoreColor(score: number) {
  if (score >= 75) return { text: "text-success", stroke: "hsl(140, 50%, 45%)" }
  if (score >= 50) return { text: "text-warning", stroke: "hsl(45, 90%, 55%)" }
  return { text: "text-destructive", stroke: "hsl(0, 72%, 55%)" }
}
